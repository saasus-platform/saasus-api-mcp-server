...
const apiTool = {
  ...
  definition: {
    ...
    function: {
      ...
      description: `Request User Email Update: Request to update the user's email address. Sends a verification code to the requested email address. Requires the user's access token. The verification code is valid for 24 hours. This API is only available for email-authenticated users. Sign-in ID authentication users cannot use this API. `,
      parameters: {
      "type": "object",
      "properties": {
            "user_id": {
