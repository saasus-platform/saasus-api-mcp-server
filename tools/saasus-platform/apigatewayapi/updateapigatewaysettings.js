            ...
            "endpoint_settings_list": {
                  ...
                  "items": {
                        ...
                        "properties": {
                              ...
                              "throttlings": {
                                    "title": "Throttling Settings List",
                                    "x-title-i18n": {
                                          "jpn": "スロットリング設定一覧"
                                    },
                                    "description": "Throttling settings for each target\nTODO: Make it possible to set multiple settings in the future\n",
                                    "x-description-i18n": {
                                          "jpn": "targetごとのスロットリング設定\nTODO: 今後の実装で複数設定できるようにする\n"
                                    },
                                    "type": "array",
                                    "items": {
                              ...
                              "mapping_endpoint_id": {
                                    "title": "Mapping Endpoint ID",
                                    "x-title-i18n": {
                                          "jpn": "マッピングエンドポイントID"
                                    },
                                    "description": "Identifier for the function to be executed when calling the API",
                                    "x-description-i18n": {
                                          "jpn": "APIコール時に実行される関数を識別するためのID"
                                    },
                                    "type": "string",
